...
plotter.add_points(points_to_plot, color="green", point_size=5.0, render_points_as_spheres=True)
...
#plotter.add_points(points_to_split, color="yellow", point_size=5.0, render_points_as_spheres=True)
...
for i, point in enumerate(points_to_plot):
    plotter.add_point_labels([point], [str(indices[i])], font_size=10, text_color="yellow")
